            ...
            <div className="contact-container">
                ...
                <div className="contact-info">
                    ...
                    <div className="social-icons">
                        ...
                        <a href="#" className="social-circle">{/* Facebook */}F</a>
                        <a href="#" className="social-circle">{/* Instagram */}I</a>
                        <a href="#" className="social-circle">{/* LinkedIn */}L</a>
                        <a href="#" className="social-circle">{/* WhatsApp */}W</a>
                    </div>
                </div>
