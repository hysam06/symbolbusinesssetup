...
const HomeContact = () => {
    return (
        <section className="section-contact-home" style={{ padding: '80px 20px', background: '#f7f4f3' }}>
            <div className="contact-container" style={{ margin: '0 auto' }}>
                {/* Left Column: Contact Info */}
                <div className="contact-info">
                    <h2 className="info-title" style={{ color: 'var(--color-dark-purple)' }}>Ready to Start Your Business Journey?</h2>
                    <p className="info-subtitle" style={{ color: 'var(--color-dark-purple)', opacity: 0.8 }}>
                    ...
                    <div className="contact-details">
                        ...
                        <div className="detail-item">
                            <div className="icon-circle">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M21 10C21 17 12 23 12 23C12 23 3 17 3 10C3 7.61305 3.94821 5.32387 5.63604 3.63604C7.32387 1.94821 9.61305 1 12 1C14.3869 1 16.6761 1.94821 18.364 3.63604C20.0518 5.32387 21 7.61305 21 10Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
